...
/// Always-linked reference into `MoEngagePersonalization`.
///
...
public enum MoEngagePersonalizationSPMLinkage {
    public static let retained: [AnyClass] = [MoEngageSDKPersonalize.self]
}
