...
/// Initializer with event attributes which is internally used by the SDK and Plugins
/// @param dataDict A dictionary instance with event attributes to be tracked
/// @remarks Do not call this method explicilty.
-(instancetype)initWithPluginPayloadDict:(NSDictionary *)dataDict;
