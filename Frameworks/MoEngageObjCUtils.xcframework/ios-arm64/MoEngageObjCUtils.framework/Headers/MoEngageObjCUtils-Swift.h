...
#ifndef MOENGAGEOBJCUTILS_SWIFT_H
#define MOENGAGEOBJCUTILS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MoEngageObjCUtils",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP17MoEngageObjCUtils41MoEngageAppDelegateAnalyticsProxyProtocol_")
...
SWIFT_PROTOCOL("_TtP17MoEngageObjCUtils41MoEngageAppDelegateMessagingProxyProtocol_")
