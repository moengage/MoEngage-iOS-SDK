#if 0
#elif (defined(__arm64__) && __arm64__) || (defined(__i386__) && __i386__)
// Generated by Apple Swift version 5.3 (swiftlang-1200.0.29.2 clang-1200.0.30.1)
#ifndef MOCARDS_SWIFT_H
#define MOCARDS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MOCards",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC7MOCards6MOCard")
@interface MOCard : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC7MOCards22MOCardNavigationAction")
@interface MOCardNavigationAction : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@optional
- (void)cardsSyncedSuccessfully;
- (void)cardsViewControllerDismissed;
- (void)cardDeletedWithCardInfo:(MOCard * _Nonnull)card;
- (BOOL)cardClickedWithCardInfo:(MOCard * _Nonnull)card andAction:(MOCardNavigationAction * _Nonnull)action SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface MOCardsListViewController (SWIFT_EXTENSION(MOCards)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC7MOCards25MOCardsNavigationBarStyle")
...
SWIFT_PROTOCOL("_TtP7MOCards17SwiftyGifDelegate_")
...
#elif (defined(__ARM_ARCH_7A__) && __ARM_ARCH_7A__) || (defined(__x86_64__) && __x86_64__)
// Generated by Apple Swift version 5.3 (swiftlang-1200.0.29.2 clang-1200.0.30.1)
#ifndef MOCARDS_SWIFT_H
#define MOCARDS_SWIFT_H
#pragma clang diagnostic push
