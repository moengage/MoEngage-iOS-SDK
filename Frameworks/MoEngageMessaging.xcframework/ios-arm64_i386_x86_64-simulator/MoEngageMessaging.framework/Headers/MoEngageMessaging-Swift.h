...
- (void)initializeMessagingWithLaunchOptions:(NSDictionary<UIApplicationLaunchOptionsKey, id> * _Nullable)launchOptions forInstanceID:(NSString * _Nonnull)instanceID;
- (void)setMessagingDelegate:(id <MOMessagingDelegate> _Nullable)delegate forAppID:(NSString * _Nullable)appID;
- (void)registerForRemoteNotificationWithCategories:(NSSet<UNNotificationCategory *> * _Nullable)categories andUserNotificationCenterDelegate:(id <UNUserNotificationCenterDelegate> _Nullable)delegate;
...
+ (BOOL)isMoEngageSilentPushAppLaunchWithLaunchOptions:(NSDictionary<UIApplicationLaunchOptionsKey, id> * _Nullable)launchOptions SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nullable)getPushToken SWIFT_WARN_UNUSED_RESULT;
@end


@interface MOMessaging (SWIFT_EXTENSION(MoEngageMessaging)) <UNUserNotificationCenterDelegate>
- (void)userNotificationCenter:(UNUserNotificationCenter * _Nonnull)center didReceiveNotificationResponse:(UNNotificationResponse * _Nonnull)response withCompletionHandler:(void (^ _Nonnull)(void))completionHandler;
- (void)userNotificationCenter:(UNUserNotificationCenter * _Nonnull)center willPresentNotification:(UNNotification * _Nonnull)notification withCompletionHandler:(void (^ _Nonnull)(UNNotificationPresentationOptions))completionHandler;
@end


@interface MOMessaging (SWIFT_EXTENSION(MoEngageMessaging)) <MOAppDelegateMessagingProxyProtocol>
