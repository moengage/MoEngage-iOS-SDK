Pod::Spec.new do |s|
  ...
  s.ios.vendored_frameworks = 'Frameworks/MoEngageInApp/MOInApp.framework'
  s.preserve_paths = 'Frameworks/MoEngageInApp/MOInApp.framework'
  s.module_map = 'Frameworks/MoEngageInApp/MOInApp.framework/Modules/module.modulemap'
